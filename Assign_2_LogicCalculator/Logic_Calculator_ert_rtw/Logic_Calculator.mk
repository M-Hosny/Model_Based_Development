###########################################################################
## Makefile generated for Simulink model 'Logic_Calculator'. 
## 
## Makefile     : Logic_Calculator.mk
## Generated on : Sat Feb 19 04:38:11 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Logic_Calculator.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\MOHAME~1\Desktop\ITI\MBD\LEC1\ASSIGN~2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Logic_Calculator_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Logic_Calculator_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Logic_Calculator.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\Logic_Calculator_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=Logic_Calculator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\Logic_Calculator_ert_rtw\Logic_Calculator.c

MAIN_SRC = $(START_DIR)\Logic_Calculator_ert_rtw\ert_main.c
...
{$(START_DIR)\Logic_Calculator_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Logic_Calculator_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
