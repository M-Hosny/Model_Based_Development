###########################################################################
## Makefile generated for Simulink model 'Factorial_using_charts'. 
## 
## Makefile     : Factorial_using_charts.mk
## Generated on : Tue Apr 05 20:15:41 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Factorial_using_charts.exe
...
PRODUCT_NAME              = Factorial_using_charts
MAKEFILE                  = Factorial_using_charts.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\MOHAME~1\Desktop\ITI\MBD\LEC3\LEC_3_~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Factorial_using_charts_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Factorial_using_charts_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Factorial_using_charts.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\Factorial_using_charts_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=Factorial_using_charts -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\Factorial_using_charts_ert_rtw\Factorial_using_charts.c

MAIN_SRC = $(START_DIR)\Factorial_using_charts_ert_rtw\ert_main.c
...
OBJS = Factorial_using_charts.obj
...
{$(START_DIR)\Factorial_using_charts_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Factorial_using_charts_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
